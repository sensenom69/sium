<div class="cos">
    ...
    <!--! FIN boto_nou --> 
    <div class="llistat_videos">
        ##ini_insercio##
            <div class="listado_videos " id="celda-##id##" >
                <iframe width="250px" src="http://www.youtube.com/embed/##url_video##" frameborder="0" allowfullscreen></iframe>
                <br />
                <span class="listado_##tabla##" id="celda-##id##">##name##</span>
            </div>
        ##fi_insercio##
    </div>
