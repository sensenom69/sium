(function() {
  ...
  angular
    ...
    .controller('ObraDetallController', ['$scope', '$http', '$window', '$location','PlaceholderTextService', 'ngTableParams', '$filter','$mdDialog', ObraDetallController]);

  function ObraDetallController($scope, $http, $window, $location, PlaceholderTextService, ngTableParams, $filter,$mdDialog) {
